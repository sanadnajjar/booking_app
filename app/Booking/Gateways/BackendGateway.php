...
/*
|--------------------------------------------------------------------------
| app/Booking/Gateways/BackendGateway.php *** Copyright netprogs.pl | available only at Udemy.com | further distribution is prohibited  ***
|--------------------------------------------------------------------------
*/
...
class BackendGateway {
    ...
    public function saveObject($id, $request)
    {
        ...
        {
            $this->validate($request, Photo::imageRules($request, 'objectPictures'));
    ...
    public function saveRoom($id, $request)
    {
        ...
        {
            $this->validate($request, Photo::imageRules($request, 'roomPictures'));
    ...
    public function checkNotificationsStatus($request)
    {
        ...
        $memcache = new \App\Booking\Services\FakedMemcached();
