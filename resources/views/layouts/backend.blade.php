...
{{--    <!--[if lt IE 9]><script src="../../js/ie8-responsive-file-warning.js"></script><![endif]-->--}}
    ...
    <link rel="stylesheet" href="{{ url('css/app.css') }}">  <!-- Lecture 5  -->
    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="navbar-text" href="{{route('profile')}}">{{Auth::user()->FullName}}</a></li>
...
<script src="{{ url('js/app.js') }}"></script> <!-- Lecture 5 -->
<script src="{{ url('js/admin.js') }}"></script> <!-- Lecture 5 -->
